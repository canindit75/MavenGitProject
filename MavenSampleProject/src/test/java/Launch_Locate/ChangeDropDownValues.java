...
public class ChangeDropDownValues {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Extra Active 
		ss.selectByVisibleText("Extra Active: very intense exercise daily, or physical job");
		Thread.sleep(2000);
		System.out.println("Dropdown Value changed by VisibleText to Extra Active : " + ss.getFirstSelectedOption().getText());
		
		WebElement ModerativelyActiveOption = driver.findElement(By.xpath("//*[@id='cactivity']/option[text()='Moderate: exercise 4-5 times/week']"));
