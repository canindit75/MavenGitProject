...
public class CalorieCalcPage {
	...
	private WebElement heightmeterTextbox;
	...
	public void EnterCalorieDetails(String age, String sex, String weight,String height){
		ageTextbox.clear();
		...
		heightmeterTextbox.sendKeys(height);
