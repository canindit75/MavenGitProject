...
public class CalorieCalcPageExcelTestCaseConfig {
	...
	public void CalorieCalcTestCaseMethod(Hashtable<String,String> caldata) throws InterruptedException, IOException{		
		...
		cp.EnterCalorieDetails(caldata.get("age"), caldata.get("sex"), caldata.get("weight"),caldata.get("height"));
		Thread.sleep(3000);
	}
	...
	public Object[][] getCalorieDetails() throws IOException{
		String filepath= System.getProperty("user.dir")+"/src/test/java/com/caloriecalc/testdata";
